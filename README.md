...
The plots generated by the scripts are Plot1.PNG, Plot2.PNG, Plot3.PNG and Plot4.PNG. The files can be found in this  repository at the root level as well as under '/figure' folder.
